...
function displayTable(data){
    ...
    if(document.getElementById("studentDepartment").value != "All"){
        tempData = filterDepartment(tempData, document.getElementById("studentDepartment").value)
    }

    if(document.getElementById("studentSemester").value != "All"){
        tempData = filterJoiningYear(tempData, document.getElementById("studentSemester").value)
    }
    ...
    tab += '</table>'
    return document.getElementById("studentTable").innerHTML = tab;
}
